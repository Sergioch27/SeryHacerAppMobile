...
const CheckoutForm = () => {
  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        Alert.alert('No se pudo cargar tu información', error?.message ?? 'Intenta nuevamente.');
      } finally {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Pago iniciado', 'Se abrió Transbank para completar el pago.');
    } catch (error) {
    ...
    <View style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <LoginInput style={styles.input} placeholder="Teléfono" value={form.phone} onChangeText={(value) => handleChange('phone', value)} />
          ...
          <LoginInput style={styles.input} placeholder="Dirección" value={form.address_1} onChangeText={(value) => handleChange('address_1', value)} />
          ...
          <LoginInput style={styles.input} placeholder="Región" value={form.state} onChangeText={(value) => handleChange('state', value)} />
          <LoginInput style={styles.input} placeholder="Código postal" value={form.postcode} onChangeText={(value) => handleChange('postcode', value)} />
          <LoginInput style={styles.input} placeholder="País" value={form.country} onChangeText={(value) => handleChange('country', value)} />
        </View>
